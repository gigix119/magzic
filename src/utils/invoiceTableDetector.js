...
const COL_KEYWORDS = {
  ...
  JEDNOSTKA:      ['jm', 'j m', 'jednostka', 'miara', 'jedn', 'jdn', 'jdn.', 'unit', 'mb', 'm2'],
  CENA_NETTO:     ['cena', 'cena j', 'cena jedn', 'cena jednostkowa',
                   'cena netto', 'cena netto j', 'cena jedn netto', 'cena jdn netto',
                   'cena po rabacie'],
  ...
  WARTOSC_BRUTTO: ['wartosc brutto', 'brutto', 'razem brutto', 'kwota brutto', 'wart brutto', 'wartosc jdn brutto'],
  CENA_BRUTTO:    ['cena brutto', 'cena brutto j', 'cena jedn brutto', 'cena jdn brutto'],
