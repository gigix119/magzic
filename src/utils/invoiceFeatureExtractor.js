...
// Signal lists — mirrors invoiceDocumentClassifier to avoid circular imports
...
const SUMMARY_KEYWORDS = ['razem', 'suma', 'do zapłaty', 'wartość faktury', 'razem netto']
const INVENTORY_ITEM_KEYWORDS = [
